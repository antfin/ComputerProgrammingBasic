	...
	myDiagram.add(
		$(go.Part, "Table",
			...
			$(go.Panel, "Horizontal",
				...
				$(go.TextBlock, json.color["yellow"],
					{ font: "700 13px Droid Serif, sans-serif" })
			),  // end row 2
			$(go.Panel, "Horizontal",
